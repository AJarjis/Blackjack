 ...
 * Date        : 12-Jan-2018
 *
 * Description : An interface for a player in a game of blackjack
 *
 * Author      : Ali Jarjis
 *
 ***************************************************************************** */
...
interface Player {
    ...
    /**
     * makeBet: This method determines what bet the player will make. It should
     * be called prior to any cards being dealt.
     */
    int makeBet();
